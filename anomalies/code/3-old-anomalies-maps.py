...
s = 1
pre = cru_ts_pre.variables['pre'][iref_start:iref_end,::s,::s]
tmp = cru_ts_tmp.variables['tmp'][iref_start:iref_end,::s,::s]
...
# %%
# compute monthly mean and sample standard deviation
def monthly_stats(var):
    ...
    for imonth in range(12):
        month_mean.append(np.mean(var[imonth::12], axis=0))
        month_std.append(np.std(var[imonth::12], axis=0))
